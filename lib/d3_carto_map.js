...
var Map = module.exports = function() {
    ...
    .on("click", manualZoom).html(function(d) {return d=="in" ? '<span class="glyphicon glyphicon-plus" aria-hidden="true"></span>' : '<span class="glyphicon glyphicon-minus" aria-hidden="true"></span>'});
